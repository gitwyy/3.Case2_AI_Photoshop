...
def discriminator_model():
    ...
    model.add(tf.keras.layers.MaxPool2D(pool_size=(2, 2)))  # 池化层 32，32 ，64
    model.add(tf.keras.layers.Conv2D(128, (5, 5))) # 32， 32，128
    model.add(tf.keras.layers.Activation("tanh"))
    model.add(tf.keras.layers.MaxPool2D(pool_size=(2, 2))) # 16，16，128
    model.add(tf.keras.layers.Conv2D(128, (5, 5))) # 16，16，128
    model.add(tf.keras.layers.Activation("tanh"))
    model.add(tf.keras.layers.MaxPool2D(pool_size=(2, 2))) # 8，8，128
