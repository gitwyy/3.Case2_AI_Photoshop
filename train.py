...
def train():
    ...
    for epoch in range(EPOCHS):
        ...
        if epoch % 10 == 9:
            ...
            g.save_weights("weight/generator_weight.h5", True, "h5")
            d.save_weights("weight/discriminator_weight.h5", True, "h5")
...
def re_train():
    ...
    g.load_weights("weight/generator_weight.h5")
    d.load_weights("weight/discriminator_weight.h5")
